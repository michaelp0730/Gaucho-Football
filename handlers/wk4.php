...
if (!empty($_POST['wk4gm1']) && !empty($_POST['wk4gm2']) && !empty($_POST['wk4gm3']) && !empty($_POST['wk4gm4']) &&
    !empty($_POST['wk4gm5']) && !empty($_POST['wk4gm6']) && !empty($_POST['wk4gm7']) && !empty($_POST['wk4gm8']) &&
    !empty($_POST['wk4gm9']) && !empty($_POST['wk4gm10']) && !empty($_POST['wk4gm11']) && !empty($_POST['wk4gm12']) &&
    !empty($_POST['wk4gm13']) && !empty($_POST['wk4-tiebreaker']) && !empty($_SESSION['LoggedIn']) && !empty($_SESSION['Username'])) {
    ...
    $due_date = strtotime('2014-09-25T20:25:00-04:00');
    $submission_time = strtotime('now');
    $check_user_submission = mysql_query("SELECT * FROM wk4 WHERE Username = '".$username."'");
    ...
    if ($submission_time > $due_date) {
        ...
        $submit_wk4 = mysql_query("INSERT INTO wk4 (Username, wk4gm1, wk4gm2, wk4gm3, wk4gm4, wk4gm5, wk4gm6, wk4gm7, wk4gm8,
            wk4gm9, wk4gm10, wk4gm11, wk4gm12, wk4gm13, MondayTotalPoints, wk4Complete)
            VALUES('".$username."', '".$wk4gm1."', '".$wk4gm2."', '".$wk4gm3."', '".$wk4gm4."', '".$wk4gm5."', '".$wk4gm6."',
            '".$wk4gm7."', '".$wk4gm8."', '".$wk4gm9."', '".$wk4gm10."', '".$wk4gm11."', '".$wk4gm12."', '".$wk4gm13."', '".$tiebreaker."', true)");
