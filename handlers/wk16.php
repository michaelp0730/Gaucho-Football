...
if (!empty($_POST['wk16gm1']) && !empty($_POST['wk16gm2']) && !empty($_POST['wk16gm3']) &&
    !empty($_POST['wk16gm4']) && !empty($_POST['wk16gm5']) && !empty($_POST['wk16gm6']) &&
    !empty($_POST['wk16gm7']) && !empty($_POST['wk16gm8']) && !empty($_POST['wk16gm9']) &&
    !empty($_POST['wk16gm10']) && !empty($_POST['wk16gm11']) && !empty($_POST['wk16gm12']) &&
    !empty($_POST['wk16gm13']) && !empty($_POST['wk16-tiebreaker']) &&
    ...
    $due_date = strtotime('2015-12-27T13:00:00-05:00');
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk16 = mysql_query("INSERT INTO wk16 (Username, wk16gm1, wk16gm2, wk16gm3, wk16gm4,
            wk16gm5, wk16gm6, wk16gm7, wk16gm8, wk16gm9, wk16gm10, wk16gm11, wk16gm12, wk16gm13,
            MondayTotalPoints, wk16Complete)
            VALUES('".$username."', '".$wk16gm1."', '".$wk16gm2."', '".$wk16gm3."', '".$wk16gm4."',
            '".$wk16gm5."', '".$wk16gm6."', '".$wk16gm7."', '".$wk16gm8."', '".$wk16gm9."',
            '".$wk16gm10."', '".$wk16gm11."', '".$wk16gm12."', '".$wk16gm13."', '".$tiebreaker."', true)");
