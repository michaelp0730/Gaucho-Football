...
if (!empty($_POST['wk3gm1']) && !empty($_POST['wk3gm2']) && !empty($_POST['wk3gm3']) && !empty($_POST['wk3gm4']) &&
    !empty($_POST['wk3gm5']) && !empty($_POST['wk3gm6']) && !empty($_POST['wk3gm7']) && !empty($_POST['wk3gm8']) &&
    !empty($_POST['wk3gm9']) && !empty($_POST['wk3gm10']) && !empty($_POST['wk3gm11']) && !empty($_POST['wk3gm12']) &&
    !empty($_POST['wk3gm13']) && !empty($_POST['wk3gm14']) && !empty($_POST['wk3gm15']) && !empty($_POST['wk3gm16']) &&
    ...
    $wk3gm16 = mysql_real_escape_string($_POST['wk3gm16']);
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk3 = mysql_query("INSERT INTO wk3 (Username, wk3gm1, wk3gm2, wk3gm3, wk3gm4, wk3gm5, wk3gm6, wk3gm7, wk3gm8,
            wk3gm9, wk3gm10, wk3gm11, wk3gm12, wk3gm13, wk3gm14, wk3gm15, wk3gm16, MondayTotalPoints, wk3Complete)
            VALUES('".$username."', '".$wk3gm1."', '".$wk3gm2."', '".$wk3gm3."', '".$wk3gm4."', '".$wk3gm5."', '".$wk3gm6."',
            '".$wk3gm7."', '".$wk3gm8."', '".$wk3gm9."', '".$wk3gm10."', '".$wk3gm11."', '".$wk3gm12."', '".$wk3gm13."', '".$wk3gm14."', '".$wk3gm15."', '".$wk3gm16."', '".$tiebreaker."', true)");
