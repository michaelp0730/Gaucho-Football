...
if (!empty($_POST['wk12gm1']) && !empty($_POST['wk12gm2']) && !empty($_POST['wk12gm3']) &&
    !empty($_POST['wk12gm4']) && !empty($_POST['wk12gm5']) && !empty($_POST['wk12gm6']) &&
    !empty($_POST['wk12gm7']) && !empty($_POST['wk12gm8']) && !empty($_POST['wk12gm9']) &&
    !empty($_POST['wk12gm10']) && !empty($_POST['wk12gm11']) && !empty($_POST['wk12gm12']) &&
    !empty($_POST['wk12gm13']) && !empty($_POST['wk12-tiebreaker']) &&
    ...
    $due_date = strtotime('2014-11-20T20:25:00-05:00');
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk12 = mysql_query("INSERT INTO wk12 (Username, wk12gm1, wk12gm2, wk12gm3, wk12gm4,
            wk12gm5, wk12gm6, wk12gm7, wk12gm8, wk12gm9, wk12gm10, wk12gm11, wk12gm12, wk12gm13,
            MondayTotalPoints, wk12Complete)
            VALUES('".$username."', '".$wk12gm1."', '".$wk12gm2."', '".$wk12gm3."', '".$wk12gm4."',
            '".$wk12gm5."', '".$wk12gm6."', '".$wk12gm7."', '".$wk12gm8."', '".$wk12gm9."',
            '".$wk12gm10."', '".$wk12gm11."', '".$wk12gm12."', '".$wk12gm13."', '".$tiebreaker."', true)");
