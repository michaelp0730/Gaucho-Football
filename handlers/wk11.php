...
if (!empty($_POST['wk11gm1']) && !empty($_POST['wk11gm2']) && !empty($_POST['wk11gm3']) &&
    !empty($_POST['wk11gm4']) && !empty($_POST['wk11gm5']) && !empty($_POST['wk11gm6']) &&
    !empty($_POST['wk11gm7']) && !empty($_POST['wk11gm8']) && !empty($_POST['wk11gm9']) &&
    !empty($_POST['wk11gm10']) && !empty($_POST['wk11gm11']) && !empty($_POST['wk11gm12']) &&
    !empty($_POST['wk11gm13']) && !empty($_POST['wk11-tiebreaker']) &&
    ...
    $due_date = strtotime('2015-11-22T13:00:00-05:00');
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk11 = mysql_query("INSERT INTO wk11 (Username, wk11gm1, wk11gm2, wk11gm3, wk11gm4,
            wk11gm5, wk11gm6, wk11gm7, wk11gm8, wk11gm9, wk11gm10, wk11gm11, wk11gm12, wk11gm13,
            MondayTotalPoints, wk11Complete)
            VALUES('".$username."', '".$wk11gm1."', '".$wk11gm2."', '".$wk11gm3."', '".$wk11gm4."',
            '".$wk11gm5."', '".$wk11gm6."', '".$wk11gm7."', '".$wk11gm8."', '".$wk11gm9."',
            '".$wk11gm10."', '".$wk11gm11."', '".$wk11gm12."', '".$wk11gm13."',
            '".$tiebreaker."', true)");
