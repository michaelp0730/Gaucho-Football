...
if (!empty($_POST['wk14gm1']) && !empty($_POST['wk14gm2']) && !empty($_POST['wk14gm3']) &&
    !empty($_POST['wk14gm4']) && !empty($_POST['wk14gm5']) && !empty($_POST['wk14gm6']) &&
    !empty($_POST['wk14gm7']) && !empty($_POST['wk14gm8']) && !empty($_POST['wk14gm9']) &&
    !empty($_POST['wk14gm10']) && !empty($_POST['wk14gm11']) && !empty($_POST['wk14gm12']) &&
    !empty($_POST['wk14gm13']) && !empty($_POST['wk14gm14']) && !empty($_POST['wk14gm15']) &&
    !empty($_POST['wk14-tiebreaker']) && !empty($_SESSION['LoggedIn']) &&
    ...
    $due_date = strtotime('2015-12-13T13:00:00-05:00');
    $submission_time = strtotime('now');
    $check_user_submission = mysql_query("SELECT wk14Complete FROM wk14 WHERE Username = '".$username."'");
    $submission_response_array = mysql_fetch_array($check_user_submission);

    if ($submission_response_array[0] == 1) {
        echo '<div class="alert alert-danger" role="alert"><strong>Error:</strong> You have already submitted your Week 14 picks. All submissions are final.</div>';
        ...
        $submit_wk14 = mysql_query("INSERT INTO wk14 (Username, wk14gm1, wk14gm2, wk14gm3, wk14gm4,
            wk14gm5, wk14gm6, wk14gm7, wk14gm8, wk14gm9, wk14gm10, wk14gm11, wk14gm12, wk14gm13,
            wk14gm14, wk14gm15, MondayTotalPoints, wk14Complete)
            VALUES('".$username."', '".$wk14gm1."', '".$wk14gm2."', '".$wk14gm3."', '".$wk14gm4."',
            '".$wk14gm5."', '".$wk14gm6."', '".$wk14gm7."', '".$wk14gm8."', '".$wk14gm9."',
            '".$wk14gm10."', '".$wk14gm11."', '".$wk14gm12."', '".$wk14gm13."', '".$wk14gm14."',
            '".$wk14gm15."', '".$tiebreaker."', true)");
