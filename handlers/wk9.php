...
if (!empty($_POST['wk9gm1']) && !empty($_POST['wk9gm2']) && !empty($_POST['wk9gm3']) &&
    !empty($_POST['wk9gm4']) && !empty($_POST['wk9gm5']) && !empty($_POST['wk9gm6']) &&
    !empty($_POST['wk9gm7']) && !empty($_POST['wk9gm8']) && !empty($_POST['wk9gm9']) &&
    !empty($_POST['wk9gm10']) && !empty($_POST['wk9gm11']) && !empty($_POST['wk9gm12']) &&
    !empty($_POST['wk9-tiebreaker']) && !empty($_SESSION['LoggedIn']) &&
    ...
    $due_date = strtotime('2015-11-08T13:00:00-05:00');
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk9 = mysql_query("INSERT INTO wk9 (Username, wk9gm1, wk9gm2, wk9gm3, wk9gm4,
            wk9gm5, wk9gm6, wk9gm7, wk9gm8, wk9gm9, wk9gm10, wk9gm11, wk9gm12, MondayTotalPoints,
            wk9Complete)
            VALUES('".$username."', '".$wk9gm1."', '".$wk9gm2."', '".$wk9gm3."', '".$wk9gm4."',
            '".$wk9gm5."', '".$wk9gm6."', '".$wk9gm7."', '".$wk9gm8."', '".$wk9gm9."',
            '".$wk9gm10."', '".$wk9gm11."', '".$wk9gm12."', '".$tiebreaker."', true)");
