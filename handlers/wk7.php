...
if (!empty($_POST['wk7gm1']) && !empty($_POST['wk7gm2']) && !empty($_POST['wk7gm3']) && !empty($_POST['wk7gm4']) &&
    !empty($_POST['wk7gm5']) && !empty($_POST['wk7gm6']) && !empty($_POST['wk7gm7']) && !empty($_POST['wk7gm8']) &&
    !empty($_POST['wk7gm9']) && !empty($_POST['wk7gm10']) && !empty($_POST['wk7gm11']) && !empty($_POST['wk7gm12']) &&
    !empty($_POST['wk7gm13']) && !empty($_POST['wk7gm14']) && !empty($_POST['wk7gm15']) && !empty($_POST['wk7-tiebreaker']) &&
    ...
    $wk7gm13 = mysql_real_escape_string($_POST['wk7gm13']);
    $wk7gm14 = mysql_real_escape_string($_POST['wk7gm14']);
    $wk7gm15 = mysql_real_escape_string($_POST['wk7gm15']);
    ...
    if ($submission_time > $due_date) {
        ...
        $submit_wk7 = mysql_query("INSERT INTO wk7 (Username, wk7gm1, wk7gm2, wk7gm3, wk7gm4, wk7gm5, wk7gm6, wk7gm7, wk7gm8,
            wk7gm9, wk7gm10, wk7gm11, wk7gm12, wk7gm13, wk7gm14, wk7gm15, MondayTotalPoints, wk7Complete)
            VALUES('".$username."', '".$wk7gm1."', '".$wk7gm2."', '".$wk7gm3."', '".$wk7gm4."', '".$wk7gm5."', '".$wk7gm6."',
            '".$wk7gm7."', '".$wk7gm8."', '".$wk7gm9."', '".$wk7gm10."', '".$wk7gm11."', '".$wk7gm12."', '".$wk7gm13."', '".$wk7gm14."', '".$wk7gm15."', '".$tiebreaker."', true)");
