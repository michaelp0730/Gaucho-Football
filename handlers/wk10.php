...
if (!empty($_POST['wk10gm1']) && !empty($_POST['wk10gm2']) && !empty($_POST['wk10gm3']) && !empty($_POST['wk10gm4']) &&
    !empty($_POST['wk10gm5']) && !empty($_POST['wk10gm6']) && !empty($_POST['wk10gm7']) && !empty($_POST['wk10gm8']) &&
    !empty($_POST['wk10gm9']) && !empty($_POST['wk10gm10']) && !empty($_POST['wk10gm11']) && !empty($_POST['wk10gm12']) &&
    !empty($_POST['wk10gm13']) && !empty($_POST['wk10-tiebreaker']) && !empty($_SESSION['LoggedIn']) && !empty($_SESSION['Username'])) {
    ...
    $due_date = strtotime('2014-11-06T20:25:00-04:00');
    $submission_time = strtotime('now');
    $check_user_submission = mysql_query("SELECT * FROM wk10 WHERE Username = '".$username."'");
    ...
    if ($submission_time > $due_date) {
        ...
        $submit_wk10 = mysql_query("INSERT INTO wk10 (Username, wk10gm1, wk10gm2, wk10gm3, wk10gm4, wk10gm5, wk10gm6, wk10gm7, wk10gm8,
            wk10gm9, wk10gm10, wk10gm11, wk10gm12, wk10gm13, MondayTotalPoints, wk10Complete)
            VALUES('".$username."', '".$wk10gm1."', '".$wk10gm2."', '".$wk10gm3."', '".$wk10gm4."', '".$wk10gm5."', '".$wk10gm6."',
            '".$wk10gm7."', '".$wk10gm8."', '".$wk10gm9."', '".$wk10gm10."', '".$wk10gm11."', '".$wk10gm12."', '".$wk10gm13."', '".$tiebreaker."', true)");
