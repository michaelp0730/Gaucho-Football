...
if (!empty($_POST['wk17gm1']) && !empty($_POST['wk17gm2']) && !empty($_POST['wk17gm3']) &&
    !empty($_POST['wk17gm4']) && !empty($_POST['wk17gm5']) && !empty($_POST['wk17gm6']) &&
    !empty($_POST['wk17gm7']) && !empty($_POST['wk17gm8']) && !empty($_POST['wk17gm9']) &&
    !empty($_POST['wk17gm10']) && !empty($_POST['wk17gm11']) && !empty($_POST['wk17gm12']) &&
    !empty($_POST['wk17gm13']) && !empty($_POST['wk17gm14']) && !empty($_POST['wk17gm15']) &&
    !empty($_POST['wk17gm16']) && !empty($_POST['wk17-tiebreaker']) &&
    ...
    $due_date = strtotime('2016-01-03T13:00:00-05:00');
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk17 = mysql_query("INSERT INTO wk17 (Username, wk17gm1, wk17gm2, wk17gm3, wk17gm4,
            wk17gm5, wk17gm6, wk17gm7, wk17gm8, wk17gm9, wk17gm10, wk17gm11, wk17gm12, wk17gm13,
            wk17gm14, wk17gm15, wk17gm16, MondayTotalPoints, wk17Complete)
            VALUES('".$username."', '".$wk17gm1."', '".$wk17gm2."', '".$wk17gm3."', '".$wk17gm4."',
            '".$wk17gm5."', '".$wk17gm6."', '".$wk17gm7."', '".$wk17gm8."', '".$wk17gm9."',
            '".$wk17gm10."', '".$wk17gm11."', '".$wk17gm12."', '".$wk17gm13."', '".$wk17gm14."',
            '".$wk17gm15."', '".$wk17gm16."', '".$tiebreaker."', true)");
