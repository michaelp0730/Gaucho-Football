...
if (!empty($_POST['wk6gm1']) && !empty($_POST['wk6gm2']) && !empty($_POST['wk6gm3']) &&
    !empty($_POST['wk6gm4']) && !empty($_POST['wk6gm5']) && !empty($_POST['wk6gm6']) &&
    !empty($_POST['wk6gm7']) && !empty($_POST['wk6gm8']) && !empty($_POST['wk6gm9']) &&
    !empty($_POST['wk6gm10']) && !empty($_POST['wk6gm11']) && !empty($_POST['wk6gm12']) &&
    !empty($_POST['wk6gm13']) && !empty($_POST['wk6-tiebreaker']) && !empty($_SESSION['LoggedIn']) &&
    ...
    $due_date = strtotime('2015-10-18T13:00:00-04:00');
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk6 = mysql_query("INSERT INTO wk6 (Username, wk6gm1, wk6gm2, wk6gm3, wk6gm4,
            wk6gm5, wk6gm6, wk6gm7, wk6gm8, wk6gm9, wk6gm10, wk6gm11, wk6gm12, wk6gm13,
            MondayTotalPoints, wk6Complete)
            VALUES('".$username."', '".$wk6gm1."', '".$wk6gm2."', '".$wk6gm3."', '".$wk6gm4."',
            '".$wk6gm5."', '".$wk6gm6."', '".$wk6gm7."', '".$wk6gm8."', '".$wk6gm9."',
            '".$wk6gm10."', '".$wk6gm11."', '".$wk6gm12."', '".$wk6gm13."', '".$tiebreaker."',
            true)");
