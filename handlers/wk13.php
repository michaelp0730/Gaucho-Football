...
if (!empty($_POST['wk13gm1']) && !empty($_POST['wk13gm2']) && !empty($_POST['wk13gm3']) && !empty($_POST['wk13gm4']) &&
    !empty($_POST['wk13gm5']) && !empty($_POST['wk13gm6']) && !empty($_POST['wk13gm7']) && !empty($_POST['wk13gm8']) &&
    !empty($_POST['wk13gm9']) && !empty($_POST['wk13gm10']) && !empty($_POST['wk13gm11']) && !empty($_POST['wk13gm12']) &&
    !empty($_POST['wk13gm13']) && !empty($_POST['wk13gm14']) && !empty($_POST['wk13gm15']) && !empty($_POST['wk13gm16']) &&
    !empty($_POST['wk13-tiebreaker']) && !empty($_SESSION['LoggedIn']) && !empty($_SESSION['Username'])) {
    ...
    $wk13gm16 = mysql_real_escape_string($_POST['wk13gm16']);
    $tiebreaker = mysql_real_escape_string($_POST['wk13-tiebreaker']);
    $due_date = strtotime('2014-11-27T12:30:00-05:00');
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk13 = mysql_query("INSERT INTO wk13 (Username, wk13gm1, wk13gm2, wk13gm3, wk13gm4, wk13gm5, wk13gm6, wk13gm7, wk13gm8,
            wk13gm9, wk13gm10, wk13gm11, wk13gm12, wk13gm13, wk13gm14, wk13gm15, wk13gm16, MondayTotalPoints, wk13Complete)
            VALUES('".$username."', '".$wk13gm1."', '".$wk13gm2."', '".$wk13gm3."', '".$wk13gm4."', '".$wk13gm5."', '".$wk13gm6."',
            '".$wk13gm7."', '".$wk13gm8."', '".$wk13gm9."', '".$wk13gm10."', '".$wk13gm11."', '".$wk13gm12."', '".$wk13gm13."', '".$wk13gm14."', '".$wk13gm15."',
            '".$wk13gm16."', '".$tiebreaker."', true)");
