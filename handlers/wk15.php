...
if (!empty($_POST['wk15gm1']) && !empty($_POST['wk15gm2']) && !empty($_POST['wk15gm3']) &&
    !empty($_POST['wk15gm4']) && !empty($_POST['wk15gm5']) && !empty($_POST['wk15gm6']) &&
    !empty($_POST['wk15gm7']) && !empty($_POST['wk15gm8']) && !empty($_POST['wk15gm9']) &&
    !empty($_POST['wk15gm10']) && !empty($_POST['wk15gm11']) && !empty($_POST['wk15gm12']) &&
    !empty($_POST['wk15gm13']) && !empty($_POST['wk15gm14']) &&
    !empty($_POST['wk15-tiebreaker']) && !empty($_SESSION['LoggedIn']) &&
    ...
    $due_date = strtotime('2015-12-20T13:00:00-05:00');
    ...
    if ($submission_response_array[0] == 1) {
        ...
        $submit_wk15 = mysql_query("INSERT INTO wk15 (Username, wk15gm1, wk15gm2, wk15gm3, wk15gm4,
            wk15gm5, wk15gm6, wk15gm7, wk15gm8, wk15gm9, wk15gm10, wk15gm11, wk15gm12, wk15gm13,
            wk15gm14, MondayTotalPoints, wk15Complete)
            VALUES('".$username."', '".$wk15gm1."', '".$wk15gm2."', '".$wk15gm3."', '".$wk15gm4."',
            '".$wk15gm5."', '".$wk15gm6."', '".$wk15gm7."', '".$wk15gm8."', '".$wk15gm9."',
            '".$wk15gm10."', '".$wk15gm11."', '".$wk15gm12."', '".$wk15gm13."', '".$wk15gm14."',
            '".$tiebreaker."', true)");
